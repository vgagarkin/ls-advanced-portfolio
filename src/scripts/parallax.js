const parallaxBuddaSection = document.querySelector(
    ".section-budda__parallax-wrapper"
  ),
  parallaxWelcomeSection = document.querySelector(
    ".welcome-section__parallax-wrapper"
  ),
